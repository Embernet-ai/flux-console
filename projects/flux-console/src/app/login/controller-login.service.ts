...
import {LoginServiceClass, SettingsServiceClass, GrowlerService, GrowlerModel, SETTINGS_SERVICE} from "flux-console-lib";
            ...
            .pipe(
                ...
                catchError((err: any) => {
                    ...
                    if (err.code === "ECONNREFUSED") {
                        ...
                        errorMessage = `Unable to login to selected Flux controller ${code}. Please make sure the selected controller is online and accessible`;
                        growlerData = new GrowlerModel(
                            'error',
                            'Error',
                            `Login Failed`,
